...
- [x] 以 500-800 字 chunk、50-100 字重叠切分教材。
- [x] chunk 元数据包含 textbook、chapter、page_start、page_end。
- [x] 建立向量索引并支持 top-5 检索。
- [x] 回答只基于检索 chunk，并附教材、章节、页码引用。
- [x] 找不到依据时固定返回“当前知识库中未找到相关信息”。
